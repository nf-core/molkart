...
We try to manage the required tasks for nf-core/molkart using GitHub issues, you probably came to this page when creating one.
...
If you'd like to write some code for nf-core/molkart, the standard workflow is as follows:
...
- Open the repo in [Codespaces](https://github.com/nf-core/molkart/codespaces)
- Tools installed
  - nf-core
  - Nextflow
